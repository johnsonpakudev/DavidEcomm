...
export const mockProductReviews: ProductReview[] = [
  {
    ...
    source_url: null,
    imported_at: null,
    author_location: "Melbourne, VIC",
    locale: "en-AU",
    include_in_rating: true,
  ...
  },
  {
    ...
    published: true,
    source: "google",
    external_id: "google:ChZDSUhNMG9nS0VJQ0FnSUR-example-002",
    source_url: "https://www.google.com/maps/reviews",
    imported_at: "2026-07-01T08:00:00.000Z",
    author_location: "Sydney, NSW",
    locale: "en-AU",
    include_in_rating: true,
  ...
  },
  {
    ...
    published: true,
    source: "import",
    external_id: "csv-row-8182-BB-003",
    source_url: null,
    imported_at: "2026-07-15T12:00:00.000Z",
    author_location: "Brisbane, QLD",
    locale: "en-AU",
    include_in_rating: true,
